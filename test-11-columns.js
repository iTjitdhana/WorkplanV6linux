...
async function test11Columns() {
  console.log('🧪 [TEST] ทดสอบข้อมูล 11 คอลัมน์...');
  
  // ทดสอบ 1.ใบสรุปงาน v.4 (11 คอลัมน์ A-K)
  const summaryData = {
  ...
  try {
    console.log('🟡 [TEST] ทดสอบ 1.ใบสรุปงาน v.4 (11 คอลัมน์):');
