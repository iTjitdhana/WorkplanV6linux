@echo off
echo ========================================
echo 🐳 Push WorkplanV6 ไปยัง Repositories ใหม่
echo ========================================
...
if %errorlevel% neq 0 (
    ...
    echo 💡 ตรวจสอบว่าได้สร้าง repository 'workplanv6-frontend' ที่ Docker Hub แล้ว
    pause
    exit /b 1
)
...
if %errorlevel% neq 0 (
    ...
    echo 💡 ตรวจสอบว่าได้สร้าง repository 'workplanv6-backend' ที่ Docker Hub แล้ว
    pause
    exit /b 1
)
